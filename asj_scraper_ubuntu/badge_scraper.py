...
for v,w,z in zip(df1.url,df1.name,df1.email):
    ...
    dict = {'Name': df1.name,'Email':df1.email, 'Badges': badgelist, 'Kotlin Basics':kotlin_basics_s, 'Functions':funct_s, 'Classes and Objects':classes_objects_s, 'Build your first Android app':build_app_s, 'Layouts':layouts_s, 'App navigation':app_navigation_s, 'Score Out of 6':score_s,'Completed All Badges':completed_all_s}
